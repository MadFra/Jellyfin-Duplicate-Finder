...
using System.Linq;
using Jellyfin.Plugin.DuplicateFinder.Api.Common;
using Jellyfin.Plugin.DuplicateFinder.Api.Data;
using Jellyfin.Plugin.DuplicateFinder.Api.Model;
using MediaBrowser.Controller.Library;
using MediaBrowser.Model.Activity;
using MediaBrowser.Model.Querying;

namespace Jellyfin.Plugin.DuplicateFinder.Api.Activities
{
